...
import { BillsAndCategoriesByMonthLineChartData } from "@/types/general"

type BillsAndCategoriesLineChartProps = {
  data: BillsAndCategoriesByMonthLineChartData[]
}

export const BillsAndCategoriesByMonthLineChart: React.FC<BillsAndCategoriesLineChartProps> = ({ data }) => {
